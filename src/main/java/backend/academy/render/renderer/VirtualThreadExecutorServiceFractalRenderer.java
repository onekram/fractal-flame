...
public class VirtualThreadExecutorServiceFractalRenderer extends AbstractExecutorServiceFractalRenderer {

    public VirtualThreadExecutorServiceFractalRenderer(
